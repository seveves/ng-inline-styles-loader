...
@Component({
  animations: [ Animations.Visibility ],
  selector: 'buttons',
  styles: [\`:-webkit-full-screen a{display:-webkit-box;display:flex}:-moz-full-screen a{display:flex}:-ms-fullscreen a{display:-ms-flexbox;display:flex}:fullscreen a{display:-webkit-box;display:-ms-flexbox;display:flex}\`],
  template: \`
    <div *ngIf="thing.canBePrepended || thing.canBeAppended || thing.canHaveSubs"
          style="position: absolute; bottom: 10px; left: 10px; z-index: 99;" [@Visibility]="visibility">
      <div ngbDropdown [up]="true">
